<div class="row">
  ...
  <div class="col-sm-6">
    <fieldset id="address">
	  ...
	  <input type="text" value="220" name="country_id" id="input-payment-country" class="form-control">
      </div>
      <div class="form-group required" style="display:none;">
        <label class="control-label" for="input-payment-zone"><?php echo $entry_zone; ?></label>
        <input type="text" value="3491" name="zone_id" id="input-payment-zone" class="form-control">
      </div>
      <?php foreach ($custom_fields as $custom_field) { ?>
