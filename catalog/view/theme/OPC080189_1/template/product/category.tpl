          ...
          <div class="product-block product-thumb">
            ...
            <div class="product-image-block-inner">
										<?php /*?><div class="image">
											<a href="<?php echo $product['href']; ?>">
												<img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a><?php */?>
            ...
            <div class="product-details">
              ...
              <div class="button-group list">
                ...
                <button type="button" class="compare" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-clone"></i></button>
              </div>
            </div>
			</div>
          </div>
