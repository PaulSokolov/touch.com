            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
					...
					<?php if ($layout_module['position'] == 'footertopinner') { ?>
                    <option value="footertopinner" selected="selected"><?php echo $text_footertopinner; ?></option>
                    <?php } else { ?>
                    <option value="footertopinner"><?php echo $text_footertopinner; ?></option>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="footertopinner"><?php echo $text_footertopinner; ?></option>';
